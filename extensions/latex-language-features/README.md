...
- Description: LaTeX compilation recipe
...
The server-side compiler can use:
1. **LaTeX Workshop Extension**: If available, delegates to the LaTeX Workshop extension
2. **System Tools**: Direct invocation of LaTeX tools (pdflatex, xelatex, lualatex, latexmk) - only available in Electron/Node.js environments
